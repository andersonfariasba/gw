...
class Itens_status extends MY_Controller {
...
<strong><i class="fa fa-check"></i></strong> ', '</div>');
    ...
    public function cadastrar($msg=null){
        ...
        if($this->form_validation->run()==FALSE){
            $content = $this->load->view("itens_status/cadastrar",$info,TRUE);
            ...
            $msg = true;
            redirect('itens_status/cadastrar/'.$msg);
        }
    }
    ...
    public function filtro(){
        try {
            ...
            $content = $this->load->view("itens_status/filtro",$info,TRUE);
            $this->loadPage($content);
   ...
   //EDIÇÃO
      public function editar($id_status,$msg=null){
          ...
          if($this->form_validation->run()==FALSE){
              ...
              $content = $this->load->view("itens_status/editar",$info,TRUE);
              $this->loadPage($content);
            ...
            $msg = true;
            redirect('itens_status/editar/'.$dados['id_status'].'/'.$msg);
           }
      }
   ...
   //VISUALIZAÇÃO
    public function visualizar($id_status){
          try {
              ...
              $content = $this->load->view("itens_status/visualizar",$info,TRUE);
              $this->loadPage($content);
