	...
	<style>
		...
		@media screen,print {
			...
			* {
			...
			#instr_header {
				background: url('<?php echo base_url().$this->imagens; ?>/logo_empresa.png') no-repeat top left;
				padding-left: 160px;
				height: 65px;
			}
...
<div id="container">
	...
	<div id="boleto">
		...
		<table class="header" border=0 cellspacing="0" cellpadding="0">
			<tbody>
			<tr>
				<td width=150><IMG SRC="<?php echo base_url().$this->imagens; ?>/logobb.jpg"></td>
				<td width=50>
		...
		<div class="barcode">
			<p><?php fbarcode($dadosboleto["codigo_barras"], base_url().$this->imagens); ?></p>
		</div>
		<div class="cut">
			<p>Corte na linha pontilhada</p>
		</div>
