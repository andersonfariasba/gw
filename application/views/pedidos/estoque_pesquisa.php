...
<div class="row">
  <div class="span12">
       <div class="widget ">
          ...
          <div class="widget-header">
            ...
            <h3>Pesquisar Produto do Estoque </h3>
              <a href="<?php echo site_url('pedidos/add_produto_venda/'.$objPedido->getId_pedido()); ?>" class="btn btn-default btn-small" id="modal_alterar_pedido"><i class="icon-pencil"></i> <strong> Novo Produto</strong></a>
    ...
    <div class="widget-content">
        ...
        <div class="campo">
           <label for="nome" class="tituloItens"><strong>Código Produto:</strong></label>
          <input type="text" name="codigo" class="span2 campoItens" id="codigo">
        </div>

       <div class="campo">
           <label for="nome" class="tituloItens"><strong>Nome Produto:</strong></label>
     ...
     <div class="campo">
        ...
        <button type="submit" class="btn btn-success btItensAdd" style="font-family: sans-serif;">
