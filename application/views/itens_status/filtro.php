<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Pesquisa Status de Entrega</h2>
            ...
            <tbody>
               <?php foreach ($listCategoria as $objCategoria): ?>
                 <tr class="dadosTabela">
                  ...
                  <td class="td-actions">
                   <a href="<?php echo site_url('itens_status/editar/'.$objCategoria->getId_status()); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Editar</a>
                  
                  <?php if($objCategoria->getId_status()!=LOC_ENTREGUE){ ?>
            ...
            <div class="modal-body">
              <div id="testmodal">
                <!--<form id="antoform" class="form-horizontal" role="form">-->
                 <form class="form-horizontal" method="post" id="forgot_form" action="<?php echo base_url(); ?>itens_status/filtro/">
...
$(function () {
 ...
 //OPERAÇÃO EXCLUSÃO 
  ...
  $('#btnYes').click(function() {
    ...
    location.href="<?php echo site_url('itens_status/excluir'); ?>/"+id;
