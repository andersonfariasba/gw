...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
				...
				<div class="x_title">
					<h2>Cadastrar Status de Entrega</h2>
					<ul class="nav navbar-right panel_toolbox">
					
					<li><a href="<?php echo site_url('itens_status/filtro'); ?>"><i class="fa fa-search"></i> <strong>Pesquisar</strong></a></li>
					<li><a href="<?php echo site_url('itens_painel/menu'); ?>"><i class="fa fa-bar-chart"></i> <strong>Relatórios</strong></a></li>
					</ul>                     
				...
				<div class="x_content"> <!-- INICIO MIOLO-->
			  	  ...
			  	  <?php echo form_open('itens_status/cadastrar',array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
