				...
				<div class="x_content"> <!-- INICIO MIOLO-->
				   ...
				   <div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback">
					...
					<div class="alert alert-danger alert-dismissible fade in" role="alert"  id="msgOk">
						...
						<strong><i class="fa fa-exclamation"></i> Verifique a quantidade inserida, provavelmente a quantidade está superior a quantidade solicitada</strong>
                          ...
                          <a class="antoo" style="color:#fff; font-weight:500;">Bulk Actions ( <span class="action-cnt"> </span> ) <i class="fa fa-chevron-down"></i></a>
							...
							<tr class="dadosTabela">
							 ...
							 <td class="a-center "> 
                          	...
                          	<input type="checkbox" class="flat" name="table_records[<?php echo $objIten->getId_pedido_item(); ?>]" value="<?php echo $objIten->getId_pedido_item(); ?>">
                        	<?php }else { ?>
							...
							<td><?php echo $objIten->getQtd();
							 ...
							 ?>
							  ...
							  <input type="hidden" style="width:70px;" name="qtd_solicitada[<?php echo $objIten->getId_pedido_item(); ?>]" class="form-control" value="<?php echo set_value('qtd_recebida',$objIten->getQtd()); ?>" />
							...
							if( ($objIten->getQtd()!=$total_recebido['qtd_mov']) && $total_recebido['qtd_mov'] > 0  ){
								...
								echo "<strong>".round($total_recebido['qtd_mov'])."</strong> Entregue e"; 	
							 ?>
							
							 <input type="hidden" style="width:70px;" name="total_recebido[<?php echo $objIten->getId_pedido_item(); ?>]" class="form-control" value="<?php echo set_value('total_recebido',$total_recebido['qtd_mov']); ?>"  />
							...
							<?php } else{ 
									...
									echo round($total_recebido['qtd_mov'],0);
								?>
				 ...
				 <?php if($perfil_acesso==PERFIL_MASTER || $perfil_acesso==PERFIL_CONTROLADORIA){ ?>
