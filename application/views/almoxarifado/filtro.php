    ...
    <div class="x_panel">
      <div class="x_title">
        <h2>Entrada de Produtos</h2>
          ...
          <li><a data-toggle="modal" href="#modal_pesquisa"><i class="fa fa-search"></i> <strong>Pesquisar Entrada de Produtos</strong></a></li>

          <li><a href="<?php echo site_url('almoxarifado/filtro'); ?>"><i class="fa fa-refresh"></i> <strong>Atualizar Página</strong></a></li>
            ...
            <tbody>
               <?php foreach ($listSolicitacao as $objSolicitacao): ?>
                 <tr class="dadosTabela">
                  ...
                  <td><?php echo $objDateFormat->date_format($objSolicitacao['data']); ?></td>
                    <td><?php echo number_format($objSolicitacao['valor_nf'], 2, ',', '.'); ?></td>
                      ...
                      if($objSolicitacao['id_status']==ST_RECEBIDO_PARCIAL){
                        echo "<button type='button' class='btn btn-sm btn-warning'><strong>".$objSolicitacao['status']."</strong></button>";
                      }

                      else if($objSolicitacao['id_status']==ST_RECEBIDO){
                        echo "<button type='button' class='btn btn-sm btn-success'><strong>".$objSolicitacao['status']."</strong></button>";
                      }
                      
                      else{

                        echo "<button type='button' class='btn btn-sm btn-primary'><strong>".$objSolicitacao['status']."</strong></button>";
                ...
                <td class="td-actions">
                  ...
                  <a href="<?php echo site_url('almoxarifado/visualizar/'.$objSolicitacao['id_pedido']); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> <strong>Visualizar</strong></a>
      ...
      <div id="modal_pesquisa" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title" id="myModalLabel"><i class="fa fa-search"></i> Pesquisar Entrada de Produtos</h4>
            </div>
            <div class="modal-body">
              <div id="testmodal">
                <!--<form id="antoform" class="form-horizontal" role="form">-->
                 <form class="form-horizontal" method="post" id="forgot_form" action="<?php echo base_url(); ?>almoxarifado/filtro/">
