...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
				...
				<div class="x_title">
					<h2>Editar Abertura de Caixa</h2>
				...
				<div class="x_content"> <!-- INICIO MIOLO-->
			  	  ...
			  	  <?php echo form_open('caixa_abertura/editar/'.$objCaixa->getId_abertura(),array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
			  	  <input type="hidden" name="id_abertura" value="<?php echo $objCaixa->getId_abertura(); ?>">
