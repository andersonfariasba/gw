...
<a href="<?php echo site_url('relatorio_pedido/menu'); ?>" class="btn btn-small btn-info"><i class="btn-icon-only icon-search"></i>Menu Vendas</a>
</div>
...
<div class="row">
  <div class="span12">
       <div class="widget ">
           ...
           <img src="<?php echo base_url()."/imgs/pedidos.png"?>" width="30px" border="0">
      ...
      <!--  <form action="" id="edit-profile" class="form-horizontal">-->
       ...
       <form class="contact" method="post" target="_blank" id="forgot_form" action="<?php echo base_url(); ?>relatorio_pedido/pedidos_resumo">
