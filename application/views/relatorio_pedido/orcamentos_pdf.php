...
<fieldset>
 ...
 <!--<table class="dataTable">-->
     ...
     <thead>
         <tr>                 
                  <td class="rotulo" width="50px"></td>
                  <td class="rotulo" width="130px">DATA</td>
                   <td class="rotulo" width="130px">CÓDIGO</td>
                  <td class="rotulo" width="120px">CLIENTE</td>
                   <td class="rotulo" width="120px">TELEFONE</td>
          ...
          ?>
                 ...
                 <td><?php echo $contador; ?></td>
                  <td><?php echo $objDateFormat->date_format_pedido($objPedido->getData_inicio()); ?></td>
                   ...
                   <td><span><?php echo $objPedido->getCodigo_orcamento(); ?></span></td>
                  <td><span><?php echo $objPedido->getCliente()->getNome_fantasia(); ?></span></td>

                  <td><span><?php echo $objPedido->getCliente()->getTelefone1(); ?></span></td>
                  ...
                  if($objPedido->getStatus()==FINALIZADO){
                   echo number_format($objPedido->getTotal_venda(), 2, ',', '.');
                  } 
            ...
            <h2>TOTAL: R$ <?php echo number_format($total + $total_lanc, 2, ',', '.'); ?></h2>
