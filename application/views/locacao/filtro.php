...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
      <?php $titulo_pedido = ($tipo == PEDIDO ? 'Locação' : 'Cotação'); ?>
        <h2>Pesquisa <?php echo ($tipo == PEDIDO ? 'Locação' : 'Cotação'); ?></h2>
          <ul class="nav navbar-right panel_toolbox">
          <li>

         <?php echo anchor_popup(site_url('locacao/solicitar_cliente/'.$tipo),' <i class="fa fa-plus-circle"></i> <strong>Nova '.$titulo_pedido.'</strong>',$janela);?></li>

        <!--li> <?php echo anchor_popup(site_url('locacao/solicitar_cliente2/'.$tipo),' <i class="fa fa-plus-circle"></i> <strong>'.$titulo_pedido.' de Serviços</strong>',$janela);?></li>-->
          ...
          <li><a data-toggle="modal" href="#modal_pesquisa"><i class="fa fa-search"></i> <strong>Pesquisar <?php echo $titulo_pedido; ?></strong></a></li>
           <li>
            ...
            <li><a href="<?php echo site_url('locacao/filtro/'.$tipo);?>"><i class="fa fa-refresh"></i> <strong>Atualizar Página</strong></a></li>
        ...
        <div class="x_content"> <!-- INICIO MIOLO-->
          ...
          <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <thead>
              <tr class="fundoTituloTabela">
                    <th>DATA</th>
                    <th>COD. <?php echo ($tipo == PEDIDO ? 'LOCAÇÃO' : 'COTAÇÃO'); ?></th>
                     <th>CLIENTE</th>
                      <th>USUÁRIO</th>
                     <th>VALOR</th>
          ...
          ?>
                 ...
                 // if($objPedido->getStatus()==FINALIZADO){
                  ...
                  <td class="td-actions">
                   <?php echo anchor_popup(site_url('locacao/novo/'.$objPedido->getId_pedido()),'<span class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i><strong> ' .$titulo_pedido.'</strong></span>',$janela);?>

                   <a href="<?php echo site_url('locacao/imprimir/'.$objPedido->getId_pedido()); ?>" class="btn btn-primary btn-sm" title="Imprimir" target="_blank"><i class="fa fa-print"></i> <strong></strong></a>
...
<?php } ?>
  ...
  <li><a href="<?php echo site_url('locacao/alterar_status_filtro/'.$objPedido->getId_pedido().'/'.$objStatus->getId_status().'/'.$objPedido->getTipo()); ?>"><i class="fa fa-check"></i> <strong><?php echo strtoupper($objStatus->getStatus()); ?></strong></a></li>
  <?php endforeach; ?>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div id="testmodal">
                 ...
                 <form class="form-horizontal" method="post" id="forgot_form" action="<?php echo base_url(); ?>locacao/filtro/<?php echo $tipo; ?>" >
      ...
      <div id="CalenderModalVenda" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title" id="myModalLabel">Deseja gerar uma Locação?</h4>
            </div>
      ...
      <div id="modal_cancelar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash"></i> Cancelar Locação</h4>
            </div>
            <div class="modal-body">
              <div id="testmodal">
              
                 <form class="contact" method="post" action="<?php echo base_url(); ?>locacao/cancelar/"; >
...
$(function () {
  ...
  $('#btnYes').click(function() {
    ...
    location.href="<?php echo site_url('locacao/excluir'); ?>/"+id;
 ...
 //OPERAÇÃO EXCLUSÃO 
  ...
  $('#btnYesVenda').click(function() {
   ...
   var id = $('#CalenderModalVenda').data('id');
    ...
    location.href="<?php echo site_url('locacao/alterar_cotacao_filtro'); ?>/"+id;
