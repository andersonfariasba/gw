...
$tipo = ($objPedido->getTipo()==ORCAMENTO)?"Cotação":"Locação";
?>
...
?>
            ...
            <table border="0" cellspacing="2" cellpadding="2" class="textoDadosPedido" width="100%">
              <tr>       
                ...
                <strong>Nº Pedido:<?php echo $objPedido->getCodigo(); ?></strong> 
                <?php } else{
                      echo "<strong>Nº Orçamento: ".$objPedido->getCodigo_orcamento()."</strong>";
                  }  ?>
                ...
                <td align="right" class="rotulo">Data Locação: <?php echo $objDateFormat->date_format($objPedido->getData_inicio()); ?> 
                ...
                | Hora Retirada: <?php echo $objPedido->getHora_retirada(); ?>
                </td>
              </tr>
            </table>
            ...
            <thead>
                <tr>
                  ...
                  <td class="tabelaTitulos"><strong>PRODUTO</strong></td>
                   <td class="tabelaTitulos"><strong>DATA INICIO</strong></td>
                     <td class="tabelaTitulos"><strong>DATA ENTREGA</strong></td>
                ...
                foreach($listItens as $objItem): 
                  ...
                  <tr>           
                    ...
                    <td class="tabelaItens"><?php echo $objItem->getProduto()->getDescricao(); ?></td>
                      <td class="tabelaItens"><?php echo $objDateFormat->date_format($objItem->getData_inicio()); ?></td>
                       <td class="tabelaItens"><?php echo $objDateFormat->date_format($objItem->getData_prev_entrega()); ?></td>
                    <td class="tabelaItens"><?php echo number_format($objItem->getValor_unitario(), 2, ',', '.'); ?></td>
                    <td class="tabelaItens"><?php echo round($objItem->getQtd()); ?></td>
            ...
            <thead>
                <tr>
                 <!-- <td class="tabelaTitulos"><strong>PERCENTUAL DESCONTO(%)</strong></td>-->
                  ...
                  <td class="tabelaTitulos"><strong>TOTAL PAGAR(R$)</strong></td>
                </tr>
            </thead>
                ...
                <td class="tabelaTitulos"><strong>R$: 
                 ...
                 <?php 
                    if($objPedido->getFaturado()==SIM){
                      ...
                      echo number_format($total -$objPedido->getDesconto() , 2, ',', '.'); 
                    }
                 ?>
