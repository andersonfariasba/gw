<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Pesquisa Fornecedor</h2>
          <ul class="nav navbar-right panel_toolbox">
          <li><a href="<?php echo site_url('fornecedores/cadastrar'); ?>"><i class="fa fa-plus-circle"></i> <strong>Novo Fornecedor</strong></a></li>
          <li><a data-toggle="modal" href="#modal_pesquisa"><i class="fa fa-search"></i> <strong>Pesquisar Fornecedor</strong></a></li>
          ...
          <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
             <?php foreach ($listFornecedor as $objFornecedor): ?>
                  ...
                  <td class="td-actions">
                  <a href="<?php echo site_url('fornecedores/editar/'.$objFornecedor->getId_fornecedor()); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> <strong>Visualizar</strong></a>
                  <a href="#" class="confirm-delete btn btn-danger btn-sm" data-id="<?php echo $objFornecedor->getId_fornecedor(); ?>"><i class="fa fa-trash"></i> <strong>Excluir</strong></a>
                  </td>

                   <!--<td> 
                       <a href="<?php echo site_url('fornecedores/pdf/'.$objFornecedor->getId_fornecedor()); ?>" class="btn btn-info btn-sm" target="_blank"><i class="fa fa-file-pdf-o"></i> <strong>PDF</strong></a>
                   </td>-->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div id="testmodal">
                 ...
                 <form class="form-horizontal" method="post" id="forgot_form" action="<?php echo base_url(); ?>fornecedores/filtro/">
