<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
				...
				<div class="x_title">
					<h2>Cadastrar Operadora Cartão</h2>
				...
				<div class="x_content"> <!-- INICIO MIOLO-->
			  	  ...
			  	  <?php echo form_open('operadoras_cartao/cadastrar',array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
                    ...
                    <div id="myTabContent" class="tab-content">
                      ...
                      <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
								<label>Empresa</label>
								<input type="text" class="form-control" name="empresa" id="empresa" value="<?php echo set_value('empresa')?>" maxlength="250"/>
							</div>

							<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
								<label>Central de Atendimento</label>
								<input type="text" class="form-control" name="central_atendimento" id="central_atendimento" value="<?php echo set_value('central_atendimento')?>" maxlength="250"/>
							</div>

							<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
								<label>Representante</label>
								<input type="text" class="form-control" name="representante_nome" id="representante_nome" value="<?php echo set_value('representante_nome')?>" maxlength="250"/>
							</div>

							<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
									<label>Telefone</label>
									<input type="text" class="form-control" name="representante_tel" id="representante_tel" value="<?php echo set_value('representante_tel')?>"/>
						</div>
