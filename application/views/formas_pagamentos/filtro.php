<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Pesquisa Formas de Pagamentos</h2>
            ...
            <tbody>
              <?php foreach ($listFormas as $objForma): ?>
                <tr class="dadosTabela">
                  ...
                  <td class="td-actions">
                  <a href="<?php echo site_url('formas_pagamentos/editar/'.$objForma->getId_forma()); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Editar</a>
      ...
      <div id="modal_pesquisa" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title" id="myModalLabel"><i class="fa fa-search"></i> Pesquisar Forma de Pagamentos</h4>
            </div>
            <div class="modal-body">
              <div id="testmodal">
                <!--<form id="antoform" class="form-horizontal" role="form">-->
                 <form class="form-horizontal" method="post" id="forgot_form" action="<?php echo base_url(); ?>formas_pagamentos/filtro/">
...
$(function () {
  ...
  $('#btnYes').click(function() {
    ...
    location.href="<?php echo site_url('formas_pagamentos/excluir'); ?>/"+id;
