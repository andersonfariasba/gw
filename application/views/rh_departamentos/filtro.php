<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Pesquisa Departamento RH</h2>
          ...
          <li><a data-toggle="modal" href="#modal_pesquisa"><i class="fa fa-search"></i> <strong>Pesquisar Departamento</strong></a></li>
            ...
            <tbody>
              <?php foreach ($listDep as $objDep): ?>
                 <tr class="dadosTabela">
                  ...
                  <td class="td-actions">
                  <a href="<?php echo site_url('rh_departamentos/editar/'.$objDep->getId_departamento()); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Editar</a>
                  <a href="#" class="confirm-delete btn btn-danger btn-sm" data-id="<?php echo $objDep->getId_departamento(); ?>"><i class="fa fa-trash"></i> Excluir</a>
                  </td>
            ...
            <div class="modal-body">
              <div id="testmodal">
                <!--<form id="antoform" class="form-horizontal" role="form">-->
                 <form class="form-horizontal" method="post" id="forgot_form" action="<?php echo base_url(); ?>rh_departamentos/filtro/">
                  
               
                  <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Departamento</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" class="form-control" name="departamento" value="<?php echo set_value('departamento')?>" maxlength="50"/>
                    </div>
                  </div>
