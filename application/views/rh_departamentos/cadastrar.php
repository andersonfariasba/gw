<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
				...
				<div class="x_title">
					<h2>Cadastrar Departamento RH</h2>
				...
				<div class="x_content"> <!-- INICIO MIOLO-->
					...
					<div class="form-group">
						<?php echo form_open('rh_departamentos/cadastrar',array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
						<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
							<label>Departamento</label>
							<input type="text" class="form-control" name="departamento" id="departamento" value="<?php echo set_value('departamento')?>" maxlength="50"/>
						</div>
					</div>
