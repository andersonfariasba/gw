...
<div class="row">
  <div class="span12">
      ...
      <!--  <form action="" id="edit-profile" class="form-horizontal">-->
       ...
       <form class="contact" method="post" target="_blank" id="forgot_form" action="<?php echo base_url(); ?>relatorio_financeiro/contas_receber_resumo">
      ...
      <fieldset class="grupo">
            ...
            <div class="campo">
             ...
             <div class="campo">
              ...
              <div class="campo">
                <label for="nome" class="labelDados">Forma de Recebimento:</label>
