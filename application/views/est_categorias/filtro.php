<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Pesquisa Categoria de Estoque</h2>
            ...
            <tbody>
               <?php foreach ($listCategoria as $objCategoria): ?>
                 <tr class="dadosTabela">
                  ...
                  <td class="td-actions">
                  <a href="<?php echo site_url('est_categorias/editar/'.$objCategoria->getId_categoria()); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Editar</a>
                  <a href="#" class="confirm-delete btn btn-danger btn-sm" data-id="<?php echo $objCategoria->getId_categoria(); ?>"><i class="fa fa-trash"></i> Excluir</a>
                  </td>
