...
<a href="<?php echo site_url('comp_categorias/filtro'); ?>" class="btn btn-small btn-info"><i class="btn-icon-only icon-search"></i>Buscar Categoria de Compras</a>
</div>
<div class="row">
  <div class="span12">
       <div class="widget ">
        <div class="widget-header">
                ...
                <h3>Categoria de Compra Editar</h3>
         </div> <!-- /widget-header -->
    ...
    <?php echo form_open('comp_categorias/editar/'.$objCategoria->getId_categoria(),array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
    <input type="hidden" name="id_categoria" value="<?php echo $objCategoria->getId_categoria(); ?>">    
            ...
            <div class="control-group">											
                <label class="control-label" for="categoria"><strong>Categoria de Compra:</strong></label>
                <div class="controls">
