<!-- modal filtro avançado -->	
	<div id="form-content" class="modal hide fade in" style="display: none; ">
			...
			<!--<form class="contact">-->
                        ...
                        <form class="contact" method="post" id="forgot_form" action="<?php echo base_url(); ?>comp_categorias/filtro/">
                

    			<fieldset>
		         <div class="modal-body">
		        	 <ul class="nav nav-list">
				<li class="nav-header">Categorias de Compras</li>
...
<a href="<?php echo site_url('comp_categorias/cadastrar'); ?>" class="btn btn-small btn-success"><i class="btn-icon-only icon-ok"></i>Nova Categoria de Compra</a>
  ...
  <div class="span12">
     ...
     <div class="widget ">
        <div class="widget-header">
                ...
                <h3>Categoria de Compras Listagem</h3>
         </div> <!-- /widget-header -->
            <div class="widget-content">
              <table id="listagemDados" class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <td class="td-actions">
                     <a href="<?php echo site_url('comp_categorias/editar/'.$objCategoria->getId_categoria()); ?>" class="btn btn-small btn-primary"><i class="btn-icon-only icon-pencil"></i>Editar</a>
           ...
           <div class="alert alert-success">
               <!--   <button type="button" class="close" data-dismiss="alert">&times;</button>-->
                    <strong>Nenhuma Categoria de Compra encontrada!</strong> <a href="<?php echo site_url('comp_categorias/cadastrar'); ?>" class="btn btn-small btn-success"><i class="btn-icon-only icon-ok"></i>Nova Categoria de Compra</a>
...
$('#btnYes').click(function() {
    // handle deletion here
  	...
  	$('[data-id='+id+']').remove();
  	$('#myModal').modal('hide');
  	location.href="<?php echo site_url('comp_categorias/excluir'); ?>/"+id;
