	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
				...
				<div class="x_content"> <!-- INICIO MIOLO-->
			  	  ...
			  	  <?php echo form_open('contas_banco/cadastrar',array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
                    ...
                    <div id="myTabContent" class="tab-content">
                      ...
                      <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
								<label>Banco</label>
								<input type="text" class="form-control" name="banco" id="banco" value="<?php echo set_value('banco')?>" maxlength="250"/>
							</div>

					    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
								<label>Agência</label>
								<input type="text" class="form-control" name="agencia" id="agencia" value="<?php echo set_value('agencia')?>" maxlength="50"/>
						</div>
						...
						<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
						 ...
						 <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
								...
								<input type="text" class="form-control" name="observacao" id="observacao" value="<?php echo set_value('observacao')?>" maxlength="50"/>
						</div>

						<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
									<label>Gerente</label>
									<input type="text" class="form-control" name="gerente" id="gerente" value="<?php echo set_value('gerente')?>"/>
						</div>

						<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
									<label>Central de Atendimento</label>
									<input type="text" class="form-control" name="central_atendimento" id="central_atendimento" value="<?php echo set_value('central_atendimento')?>"/>
						</div>
