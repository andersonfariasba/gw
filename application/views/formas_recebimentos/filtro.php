<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Pesquisa Formas de Recebimentos</h2>
          ...
          <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
              <?php foreach ($listFormas as $objForma): ?>
                  ...
                  <td><?php echo $objForma->getForma(); ?></td>
                                  
                  <td><?php echo $objForma->printStatus(); ?></td>
                 
                  <td class="td-actions">
                  
                  <?php if($objForma->getId_forma()!=FORMA_REC_DINHEIRO) { ?>
                  
                  <a href="<?php echo site_url('formas_recebimentos/editar/'.$objForma->getId_forma()); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Editar</a>
                  
                  
                  <a href="#" class="confirm-delete btn btn-danger btn-sm" data-id="<?php echo $objForma->getId_forma(); ?>"><i class="fa fa-trash"></i> Excluir</a>
                  <?php } ?>
      ...
      <div id="modal_pesquisa" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title" id="myModalLabel"><i class="fa fa-search"></i> Pesquisar Forma de Recebimento</h4>
            </div>
            <div class="modal-body">
              <div id="testmodal">
                <!--<form id="antoform" class="form-horizontal" role="form">-->
                 <form class="form-horizontal" method="post" id="forgot_form" action="<?php echo base_url(); ?>formas_recebimentos/filtro/">
                  
               
                  <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Forma:</label>
...
$(function () {
  ...
  $('#btnYes').click(function() {
    ...
    location.href="<?php echo site_url('formas_recebimentos/excluir'); ?>/"+id;
