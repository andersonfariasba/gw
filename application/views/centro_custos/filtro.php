<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Pesquisa Centro de Custos</h2>
            ...
            <tbody>
              <?php foreach ($listCustos as $objCusto): ?>
               <tr class="dadosTabela">
                  ...
                  <td class="td-actions">
                  <a href="<?php echo site_url('centro_custos/editar/'.$objCusto->getId_custo()); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Editar</a>
                  <a href="#" class="confirm-delete btn btn-danger btn-sm" data-id="<?php echo $objCusto->getId_custo(); ?>"><i class="fa fa-trash"></i> Excluir</a>
                  </td>
            ...
            <div class="modal-body">
              <div id="testmodal">
                <!--<form id="antoform" class="form-horizontal" role="form">-->
                 <form class="form-horizontal" method="post" id="forgot_form" action="<?php echo base_url(); ?>centro_custos/filtro/">
                  
               
                  <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Centro de Custo</label>
                      <div class="col-md-6 col-sm-9 col-xs-12">
                      <input type="text" class="form-control" name="custo" value="<?php echo set_value('custo')?>" maxlength="50"/>
                    </div>
                  </div>
