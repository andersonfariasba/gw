    ...
    <div class="x_panel">
        ...
        <div class="x_content"> <!-- INICIO MIOLO-->
          ...
          <?php } ?>
            ...
            <?php echo form_open('servicos/editar/'.$objProduto->getId_produto(),array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" tipo="moneyReal" class="form-control" name="valor_custo" id="valor_custo" value="<?php echo set_value('valor_custo',$objProduto->getValor_custo())?>" maxlength="250"/>
                        </div>
                     

                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <label>Valor Venda(R$)</label>
                        <input type="text" tipo="moneyReal" class="form-control" name="valor_venda" id="valor_venda" value="<?php echo set_value('valor_venda',$objProduto->getValor_venda())?>" maxlength="250"/>
                        </div>
                     </div>
