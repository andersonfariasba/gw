<!-- modal filtro avançado -->	
	<div id="form-content" class="modal hide fade in" style="display: none; ">
			...
			<!--<form class="contact">-->
				...
				<li><input class="input-xlarge" type="text" name="cargo" id="cargo"></li>
...
<a href="<?php echo site_url('rh_cargos/cadastrar'); ?>" class="btn btn-small btn-success"><i class="btn-icon-only icon-ok"></i>Novo Cargo</a>
  ...
  <div class="span12">
     ...
     <div class="widget ">
        <div class="widget-header">
            ...
            <div class="widget-content">
              <table id="listagemDados" class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                  <td><?php echo $objCargo->getId_cargo(); ?></td>
                  <td><?php echo $objCargo->getCargo(); ?></td>
                   <td><?php echo $objCargo->printStatus(); ?></td>
                 <td class="td-actions">
                     <a href="<?php echo site_url('rh_cargos/editar/'.$objCargo->getId_cargo()); ?>" class="btn btn-small btn-primary"><i class="btn-icon-only icon-pencil"></i>Editar</a>
                     <a href="#" class="confirm-delete btn btn-danger btn-small" data-id="<?php echo $objCargo->getId_cargo(); ?>"><i class="btn-icon-only icon-remove"> </i>Excluir</a>
           ...
           <?php if($listCargo==null):?> 
           <div class="alert alert-success">
               <!--   <button type="button" class="close" data-dismiss="alert">&times;</button>-->
                    <strong>Nenhum Cargo encontrado!</strong> <a href="<?php echo site_url('rh_cargos/cadastrar'); ?>" class="btn btn-small btn-success"><i class="btn-icon-only icon-ok"></i>Novo Cargo</a>
