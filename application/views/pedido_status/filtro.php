    ...
    <div class="x_panel">
      <div class="x_title">
        <h2>Pesquisa Status Pedido</h2>
          ...
          <li><a href="<?php echo site_url('pedido_status/cadastrar'); ?>"><i class="fa fa-plus-circle"></i> <strong>Novo Status</strong></a></li>
            ...
            <tbody>
               <?php foreach ($listCategoria as $objCategoria): ?>
                 <tr class="dadosTabela">
                  ...
                  <td class="td-actions">
                   <a href="<?php echo site_url('pedido_status/editar/'.$objCategoria->getId_status()); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Editar</a>
                  
                  <?php if($objCategoria->getId_status()!=ANDAMENTO && $objCategoria->getId_status()!=FECHADO ){ ?>
            ...
            <div class="modal-body">
              <div id="testmodal">
                <!--<form id="antoform" class="form-horizontal" role="form">-->
                 <form class="form-horizontal" method="post" id="forgot_form" action="<?php echo base_url(); ?>pedido_status/filtro/">
...
$(function () {
 ...
 //OPERAÇÃO EXCLUSÃO 
  ...
  $('#btnYes').click(function() {
    ...
    location.href="<?php echo site_url('pedido_status/excluir'); ?>/"+id;
