  ...
  <div class="tab-content">
   ...
   <div role="tabpanel" class="tab-pane active" id="home">
    ...
    <fieldset>
        ...
        <input type="text" name="comissao_venda" class="span2" tipo="moneyReal" id="comissao_venda" value="<?php echo set_value('comissao_venda',$objColaborador->getComissao_venda())?>">
             ...
             <fieldset class="grupo">
            <div class="campo">
                 <label for="email" class="labelDados">Status</label>
                 <select name="status" id="status">
                <?php $status = $objColaborador->getStatus();?>
                <option value="<?= $objColaborador->getStatus(); ?>" <?= set_select('status',$status,$objColaborador->statusIs($status)); ?>>
                <?= $objColaborador->printStatus(); ?>
