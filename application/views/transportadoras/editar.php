  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_title">
          ...
          <li><a href="<?php echo site_url('transportadoras/cadastrar'); ?>"><i class="fa fa-plus-circle"></i> <strong>Nova Transportadora</strong></a></li>
        ...
        <div class="x_content"> <!-- INICIO MIOLO-->
          ...
          <?php } ?>
           ...
           <input type="hidden" name="id_transportadora" value="<?php echo $objTransportadora->getId_transportadora(); ?>">
             ...
             <input type="hidden" id="tipo_flag" value="<?php echo $objTransportadora->getTipo(); ?>"> 
          ...
          <input type="hidden" name="data_cadastro" value="<?php echo $objTransportadora->getData_cadastro(); ?>">    
             ...
             <div class="" role="tabpanel" data-example-id="togglable-tabs">
                ...
                <p>
                      <label>Pessoa Fisica
                      <input type="radio" id="tipo_pf" name="tipo" <?php if($objTransportadora->getTipo()==PESSOA_FISICA){echo "checked=''"; }?>  value="<?php echo set_value('tipo',PESSOA_FISICA)?>"/></label> 
                      <label>Pessoa Jurídica:
                      <input type="radio" id="tipo_pj" name="tipo"<?php if($objTransportadora->getTipo()==PESSOA_JURIDICA){echo "checked=''"; }?> value="<?php echo set_value('tipo',PESSOA_JURIDICA)?>" /></label>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback">
             ...
             <div class="col-md-2 col-sm-6 col-xs-12 form-group has-feedback">
                  <label>Estado</label>
                  <input type="text" class="form-control" name="estado" id="uf" value="<?php echo set_value('estado',$objTransportadora->getEstado())?>"/>
              </div>
             ...
             <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
               ...
               <option value="<?= BLOQUEADO; ?>" <?= set_select('status',BLOQUEADO); ?>>BLOQUEADO</option>
                ...
                <!-- FINAL -->
                <div id="editor"><?php echo $objTransportadora->getObservacao(); ?>  
                 ...
                 <textarea name="observacao" id="descr" style="display: none;">
                  ...
                  <input type="text" class="form-control" name="responsavel" id="responsavel" value="<?php echo set_value('responsavel',$objTransportadora->getResponsavel())?>"/>
              </div>

              <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                  <label>Setor</label>
                  <input type="text" class="form-control" name="setor_resp" id="setor_resp" value="<?php echo set_value('setor_resp',$objTransportadora->getSetor_resp())?>"/>
              </div>

              <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                  <label>Telefone(s)</label>
                  <input type="text" class="form-control" name="telefone_resp" id="telefone_resp" value="<?php echo set_value('telefone_resp',$objTransportadora->getTelefone_resp())?>"/>
              </div>

              <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                  <label>E-mail</label>
                  <input type="text" class="form-control" name="email_resp" id="email_resp" value="<?php echo set_value('email_resp',$objTransportadora->getEmail_resp())?>"/>
              </div>
            </div>
             ...
             <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                  <label>Responsável</label>
                  <input type="text" class="form-control" name="responsavel2" id="responsavel2" value="<?php echo set_value('responsavel2',$objTransportadora->getResponsavel2())?>"/>
              </div>

              <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                  <label>Setor</label>
                  <input type="text" class="form-control" name="setor_resp2" id="setor_resp2" value="<?php echo set_value('setor_resp2',$objTransportadora->getSetor_resp2())?>"/>
              </div>

              <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                  <label>Telefone(s)</label>
                  <input type="text" class="form-control" name="telefone_resp2" id="telefone_resp2" value="<?php echo set_value('telefone_resp2',$objTransportadora->getTelefone_resp2())?>"/>
              </div>

              <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                  <label>E-mail</label>
                  <input type="text" class="form-control" name="email_resp2" id="email_resp2" value="<?php echo set_value('email_resp2',$objTransportadora->getEmail_resp2())?>"/>
              </div>
               ...
               <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                  <label>Responsável</label>
                  <input type="text" class="form-control" name="responsavel3" id="responsavel3" value="<?php echo set_value('responsavel3',$objTransportadora->getResponsavel3())?>"/>
              </div>

              <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                  <label>Setor</label>
                  <input type="text" class="form-control" name="setor_resp3" id="setor_resp3" value="<?php echo set_value('setor_resp3',$objTransportadora->getSetor_resp3())?>"/>
              </div>

              <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                  <label>Telefone(s)</label>
                  <input type="text" class="form-control" name="telefone_resp3" id="telefone_resp3" value="<?php echo set_value('telefone_resp3',$objTransportadora->getTelefone_resp3())?>"/>
              </div>

              <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
                  <label>E-mail</label>
                  <input type="text" class="form-control" name="email_resp3" id="email_resp3" value="<?php echo set_value('email_resp3',$objTransportadora->getEmail_resp3())?>"/>
              </div>
