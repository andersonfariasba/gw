  ...
  <div class="span12">
       <div class="widget ">
        <div class="widget-header">
                <i class="icon-tags"></i>
                <h3>Produto Compra Visualizar</h3>
         </div> <!-- /widget-header -->
   ...
   <div role="tabpanel" class="tab-pane active" id="home">
    ...
    <div role="tabpanel" class="tab-pane" id="obs">
        <fieldset class="grupo">
           ...
           <a href="<?php echo site_url('produtos_compras/editar/'.$objProduto->getId_produto()); ?>" class="btn btn-small btn-info"><i class="btn-icon-only icon-edit"></i>Editar Produto Compra</a>
           <a href="<?php echo site_url('produtos_compras/cadastrar'); ?>" class="btn btn-small btn-info"><i class="btn-icon-only icon-plus"></i>Novo Produto Compra</a>
           <a href="<?php echo site_url('produtos_compras/filtro'); ?>" class="btn btn-small btn-info"><i class="btn-icon-only icon-search"></i>Buscar Produto Compra</a>
