...
?>
    ...
    if($objPedido->getMesa()!=""){
       echo $objPedido->getMesa()->getNome();
      }

       if($objPedido->getGarcon()!=""){
       echo " - ".$objPedido->getGarcon()->getNome();
      }
  ...
  <li><a href="<?php echo site_url('pedidos_mesa/alterar_status/'.$objPedido->getId_pedido().'/'.$objStatus->getId_status()); ?>"><i class="fa fa-check"></i> <strong><?php echo strtoupper($objStatus->getStatus()); ?></strong></a></li>
  <?php endforeach; ?>
    ...
    <!--<button type="button" class="btn btn-sm btn-primary"><strong><i class="glyphicon glyphicon-print" aria-hidden="true" title="Imprimir Pedido"></i></strong></button>--> 
      <a href="<?php echo site_url('pedidos_mesa/imprimir/'.$objPedido->getId_pedido()); ?>" target="_blank" class="btn btn-sm btn-primary"><strong><i class="glyphicon glyphicon-print" aria-hidden="true" title="Imprimir Pedido"></i></strong></a>
...
<div class="panel panel-primary">
  ...
  <div class="panel-body" style="background-color:#FFFAFA; ">
   ...
   <?php echo form_open('pedidos_mesa/add_item/'.$objPedido->getId_pedido(),array("onsubmit"=>"return validate()","class"=>"form-horizontal","id"=>"formulario")); ?>
...
<div id="myModal" class="modal fade">
    <div class="modal-dialog">
      ...
      <option value="<?php echo $objCliente->getId_cliente(); ?>" <?php echo set_select('id_cliente',$cliente,$objPedido->clienteIs($cliente)); ?>>
           ...
           <div class="form-group">
            <label for="recipient-name" class="control-label">Garçon:</label>
           <select name="id_garcon" id="id_garcon" class="form-control">
              <?php foreach ($listColaborador as $objCol): 
                  $garcon = $objCol->getId_colaborador();
              ?>
  <option value="<?php echo $objCol->getId_colaborador(); ?>" <?php echo set_select('id_garcon',$garcon,$objPedido->garconIs($garcon)); ?>>
    ...
    e.preventDefault();
     ...
     $.ajax({
             ...
             /* if(escopo==1){ //caso seja pedido pelo estoque
              ...
              window.location.href="<?php echo site_url('pedidos_mesa/imprimir'); ?>/"+id_pedido;
              window.opener.location.href="<?php echo site_url('pedidos_mesa/filtro/2'); ?>";
    ...
    e.preventDefault();
     ...
     $.ajax({
            ...
            // setTimeout('window.location.href = "<?php echo site_url('pedidos/solicitar_cliente2/2'); ?>"; window.opener.location.href="<?php echo site_url('pedidos/filtro/1'); ?>"' , 3000);
              ...
              //window.location.href="<?php echo site_url('pedidos/solicitar_cliente/2'); ?>";
              window.opener.location.href="<?php echo site_url('pedidos_mesa/filtro/1'); ?>";
              window.close();
    ...
    e.preventDefault();
     ...
     $.ajax({
             ...
             success : function(txt){
              ...
              window.location.href="<?php echo site_url('pedidos_mesa/novo/'); ?>/"+id_pedido;
              window.opener.location.href="<?php echo site_url('pedidos_mesa/filtro/2'); ?>";
...
$('#btnYes').click(function() {
    ...
    location.href="<?php echo site_url('pedidos_mesa/excluir_item'); ?>/"+id+"/"+id_pedido;
 ...
 $('#id_produto').change(function(){
  ...
  $('#edit_pedido_btn').click(function(e){
    ...
    e.preventDefault();
     ...
     $.ajax({
             type: 'POST',
             url: "<?php echo site_url('pedidos_mesa/editar_pedido/'); ?>",         
             ...
             success : function(txt){
              ...
              $('#myModal').modal('hide');
               ...
               var tipo = 2;
               window.location.href="<?php echo site_url('pedidos_mesa/novo/'); ?>/"+id_pedido;
               window.opener.location.href="<?php echo site_url('pedidos_mesa/filtro/'); ?>/"+tipo;
