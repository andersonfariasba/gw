      ...
      <?php $titulo_pedido = ($tipo == PEDIDO ? 'Venda' : 'Cotação'); ?>
        <h2>Pesquisa <?php echo ($tipo == PEDIDO ? 'Venda' : 'Cotação'); ?></h2>
          ...
          <li>
            ...
            <li><a href="<?php echo site_url('pedidos_mesa/controle/');?>"><i class="fa fa-search"></i> <strong>Controle das Mesas</strong></a></li>

          <li><a data-toggle="modal" href="#modal_pesquisa"><i class="fa fa-search"></i> <strong>Pesquisar <?php echo $titulo_pedido; ?></strong></a></li>
           <li>

            <li><a href="<?php echo site_url('pedidos_mesa/filtro/'.$tipo);?>"><i class="fa fa-refresh"></i> <strong>Atualizar Página</strong></a></li>
        ...
        <div class="x_content"> <!-- INICIO MIOLO-->
          ...
          ?>
                  ...
                  <?php 
                      ...
                      if($objPedido->getCodigo()!=""){
                   echo "<br /> Cod. Venda: ".$objPedido->getCodigo();
                  }
                 ...
                 // if($objPedido->getStatus()==FINALIZADO){
                  ...
                  <td class="td-actions">
                   <?php echo anchor_popup(site_url('pedidos_mesa/novo/'.$objPedido->getId_pedido()),'<span class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i><strong> ' .$titulo_pedido.'</strong></span>',$janela);?>

                   <a href="<?php echo site_url('pedidos_mesa/imprimir/'.$objPedido->getId_pedido()); ?>" class="btn btn-primary btn-sm" title="Imprimir" target="_blank"><i class="fa fa-print"></i> <strong></strong></a>
...
<?php } ?>
  ...
  <li><a href="<?php echo site_url('pedidos_mesa/alterar_status_filtro/'.$objPedido->getId_pedido().'/'.$objStatus->getId_status().'/'.$objPedido->getTipo()); ?>"><i class="fa fa-check"></i> <strong><?php echo strtoupper($objStatus->getStatus()); ?></strong></a></li>
  <?php endforeach; ?>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div id="testmodal">
                 ...
                 <form class="form-horizontal" method="post" id="forgot_form" action="<?php echo base_url(); ?>pedidos_mesa/filtro/<?php echo $tipo; ?>" >
                ...
                <div class="form-group">
                      ...
                      <select class="form-control" name="id_mesa" id="id_mesa">
                        <option value="">Todos</option>
                         <?php foreach($listMesas as $objMesa): ?>
                     ...
                     <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Garçon</label>
                      <div class="col-md-6 col-sm-9 col-xs-12">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div id="testmodal">
                 ...
                 <form class="contact" method="post" action="<?php echo base_url(); ?>pedidos_mesa/cancelar/"; >
 ...
 //OPERAÇÃO EXCLUSÃO 
  ...
  $('#btnYesVenda').click(function() {
   ...
   var id = $('#CalenderModalVenda').data('id');
    ...
    location.href="<?php echo site_url('pedidos_mesa/alterar_cotacao_filtro'); ?>/"+id;
