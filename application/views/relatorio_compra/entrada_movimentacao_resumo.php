...
<a href="<?php echo site_url('relatorio_estoque/menu'); ?>" class="btn btn-small btn-info"><i class="btn-icon-only icon-search"></i>Menu Relatorio Compra</a>
</div>
  ...
  <div class="span12">
       <div class="widget ">
        <div class="widget-header" style="padding-left:5px;">
                ...
                <h3>Relatório Movimentação de Compras</h3>
         </div> <!-- /widget-header -->
      ...
      <!--  <form action="" id="edit-profile" class="form-horizontal">-->
       ...
       <form class="contact" method="post" target="_blank" id="forgot_form" action="<?php echo base_url(); ?>relatorio_compra/movimentacao">
      ...
      <fieldset class="grupo">
             ...
             <div class="campo">
              ...
              <!--<label class="radio inline">
                ...
                <label class="radio inline">
                    <input type="radio" checked="" name="tipo_movimentacao" value="<?php echo set_value('tipo_movimentacao',SAIDA)?>"> <span style="color:red;font-weight:bold">Saída</span>
                </label>
                -->

                  </label>
                          <label class="radio inline">            
                    <input type="radio" checked=""  name="tipo_movimentacao" value="<?php echo set_value('tipo_movimentacao',ENTRADA)?>"> <span style="color:green;font-weight:bold">Entrada</span>
                </label>
             </div>
