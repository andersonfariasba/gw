...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Pesquisa Caixa Sangria (Retirada)</h2>
          <ul class="nav navbar-right panel_toolbox">
          <li><a href="<?php echo site_url('caixa_sangria/cadastrar'); ?>"><i class="fa fa-plus-circle"></i> <strong>Realizar Retirada Caixa</strong></a></li>
          <li><a data-toggle="modal" href="#modal_pesquisa"><i class="fa fa-search"></i> <strong>Pesquisar Sangria de Caixa</strong></a></li>
            ...
            <tbody>
               <?php foreach ($listCaixa as $objCaixa): ?>
                 <tr class="dadosTabela">
                  ...
                  <td class="td-actions">
                  <a href="<?php echo site_url('caixa_sangria/editar/'.$objCaixa->getId_sangria()); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Visualizar</a>
                  <a href="#" class="confirm-delete btn btn-danger btn-sm" data-id="<?php echo $objCaixa->getId_sangria(); ?>"><i class="fa fa-trash"></i> Excluir</a>
                  </td>
      ...
      <div id="modal_pesquisa" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title" id="myModalLabel"><i class="fa fa-search"></i> Pesquisar Retirada Caixa (Sangria)</h4>
            </div>
            <div class="modal-body">
              <div id="testmodal">
                <!--<form id="antoform" class="form-horizontal" role="form">-->
                 <form class="form-horizontal" method="post" id="forgot_form" action="<?php echo base_url(); ?>caixa_sangria/filtro/">
...
$(function () {
 ...
 //OPERAÇÃO EXCLUSÃO 
  ...
  $('#btnYes').click(function() {
    ...
    location.href="<?php echo site_url('caixa_sangria/excluir'); ?>/"+id;
