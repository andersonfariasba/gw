<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
				...
				<div class="x_title">
					<h2>Retirar Valor Caixa (Sangria)</h2>
				...
				<div class="x_content"> <!-- INICIO MIOLO-->
			  	  ...
			  	  <?php echo form_open('caixa_sangria/cadastrar',array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
					...
					<div class="form-group">
					 ...
					 <div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
							...
							<input type="text" class="form-control" tipo="moneyReal" name="valor_retirada" id="valor_retirada" value="<?php echo set_value('valor_retirada',0)?>"/>
						</div>
