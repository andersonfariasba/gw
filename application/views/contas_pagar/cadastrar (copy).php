	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
				...
				<div class="x_content"> <!-- INICIO MIOLO-->
			  	  ...
			  	  <?php echo form_open('contas_pagar/cadastrar',array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
         ...
         <!-- <div class="form-group" id="camada_repetir" style="display:none;">-->
               ...
               <select class="form-control" name="parcela_qtd" id="parcela_qtd">
                ...
                <?php } ?>
							...
							<!--<input type="text" class="form-control" name="parcela_qtd" id="parcela_qtd" value="<?php echo set_value('parcela_qtd','1')?>"/>-->
						</div>

						<!--<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
							<label>Valor Parcela</label>
							<input type="text" readonly="readonly" class="form-control" name="valor_parcela" id="valor_parcela" value="<?php echo set_value('valor_parcela')?>"/>
						</div>-->
