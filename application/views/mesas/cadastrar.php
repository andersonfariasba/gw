	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
				...
				<div class="x_content"> <!-- INICIO MIOLO-->
			  	  ...
			  	  <?php echo form_open('mesas/cadastrar',array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" onkeypress='return SomenteNumero(event)' name="capacidade" id="capacidade" value="<?php echo set_value('capacidade')?>" maxlength="50"/>
						</div>
