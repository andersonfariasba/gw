...
<!-- DADOS SELEÇÃO DOS ITENS DO PEDIDO -->
	<div class="widget-header">
        ...
        <h3><?php echo ($tipo==ORCAMENTO)?"Orçamento":"Pedido"; ?> - Selecionar Mesa:</h3>
    </div> <!-- widget header -->



    <div class="widget-content">
     <?php echo form_open('pedidos/solicitar_cliente_comanda/'.$tipo,array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
