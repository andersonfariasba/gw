...
class Conf_statusDao extends CI_Model {
    ...
    public function cadastrar($objCategoria){
        $sucess = $this->db->insert("conf_status",$objCategoria->toArray());
        if(!$sucess){
    ...
    public function alterar($objCategoria){
    	...
    	$sucess = $this->db->update("conf_status",$objCategoria->toArray());
    ...
    public function excluir($id_status){
        ...
        $sucess = $this->db->update("conf_status",$dados);
         if(!$sucess){
             throw new Exception($this->db->_error_message(),$this->db->_error_number());
         }
    }
