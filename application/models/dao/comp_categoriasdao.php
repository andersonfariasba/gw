...
class Comp_categoriasDao extends CI_Model {
    ...
    public function cadastrar($objCategoria){
        $sucess = $this->db->insert("comp_categorias",$objCategoria->toArray());
        if(!$sucess){
    ...
    public function alterar($objCategoria){
    	...
    	$sucess = $this->db->update("comp_categorias",$objCategoria->toArray());
    ...
    public function excluir($id_categoria){
        ...
        $sucess = $this->db->update("comp_categorias",$dados);
         if(!$sucess){
             throw new Exception($this->db->_error_message(),$this->db->_error_number());
         }
    }
