...
class Com_status_itensDao extends CI_Model {
    ...
    public function cadastrar($objCategoria){
        $sucess = $this->db->insert("com_status_itens",$objCategoria->toArray());
        if(!$sucess){
    ...
    public function alterar($objCategoria){
    	...
    	$sucess = $this->db->update("com_status_itens",$objCategoria->toArray());
    ...
    public function excluir($id_status){
        ...
        $sucess = $this->db->update("com_status_itens",$dados);
         if(!$sucess){
             throw new Exception($this->db->_error_message(),$this->db->_error_number());
         }
    }
