...
class Fin_formas_recebimentosDao extends CI_Model {
    ...
    public function cadastrar($objForma){
        $sucess = $this->db->insert("fin_formas_recebimentos",$objForma->toArray());
        if(!$sucess){
    ...
    public function filtro($dados) {
    	...
    	$this->db->from("fin_formas_recebimentos");
    ...
    public function alterar($objForma){
    	...
    	$sucess = $this->db->update("fin_formas_recebimentos",$objForma->toArray());
    ...
    public function excluir($id_forma){
        ...
        $sucess = $this->db->update("fin_formas_recebimentos",$dados);
         if(!$sucess){
             throw new Exception($this->db->_error_message(),$this->db->_error_number());
         }
    }
        ...
        $listForma = array();
          ...
          if($query!=NULL){
              foreach ($query->result_array() as $dados){
               ...
               'id_forma'   => $dados['id_forma'],
               'forma'      => $dados['forma'],
               'maximo_parcela'      => $dados['maximo_parcela'],
               'data_vencimento_manual'      => $dados['data_vencimento_manual'],
               'qtd_dia_compensa'      => $dados['qtd_dia_compensa'],
               );
