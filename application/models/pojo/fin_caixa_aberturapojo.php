...
class Fin_caixa_aberturaPojo extends CI_Model {
    ...
    public function populate($dados){
        if(isset($dados["id_abertura"]))
            $this->id_abertura = $dados["id_abertura"];
    ...
    public function getId_abertura(){
        return $this->id_abertura;
    }

    public function setId_abertura($id_abertura){
