 ...
 */
class Est_movimentacaoPojo extends CI_Model {
    ...
    public function populate($dados){
       ...
       if(isset($dados["qtd_solicitada"]))
            $this->qtd_solicitada = $dados["qtd_solicitada"];
       
        if(isset($dados["qtd_mov"]))
            $this->qtd_mov = $dados["qtd_mov"];

         if(isset($dados["qtd_mov_saida"]))
            $this->qtd_mov_saida = $dados["qtd_mov_saida"];
    ...
    public function getQtd_solicitada(){
        return $this->qtd_solicitada;
    }

    public function setQtd_solicitada($qtd_solicitada){
        $this->qtd_solicitada = $qtd_solicitada;
    }

    public function getQtd_mov_saida(){
        return $this->qtd_mov_saida;
    }

    public function setQtd_mov_saida($qtd_mov_saida){
        $this->qtd_mov_saida = $qtd_mov_saida;
    }
