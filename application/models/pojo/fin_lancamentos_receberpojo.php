...
class Fin_lancamentos_receberPojo extends CI_Model {

    private $id_lancamento;
    private $id_conta;
     private $id_forma_fat; //faturamento
    private $id_forma;
    private $id_bandeira;
    ...
    if(isset($dados["pagamento_antecipado"]))
        ...
        if(isset($dados["transacao_cartao"]))
            $this->transacao_cartao = $dados["transacao_cartao"];

         if(isset($dados["taxa_operadora_cartao"]))
            $this->taxa_operadora_cartao = $dados["taxa_operadora_cartao"];
       ...
       public function getId_conta_banco() {
        ...
        public function setBandeira($bandeira) {
            ...
            public function getTransacao_cartao(){
        return $this->transacao_cartao;
    }

    public function setTransacao_cartao($transacao_cartao){
        $this->transacao_cartao = $transacao_cartao;
    }

    public function getTaxa_operadora_cartao(){
        return $this->taxa_operadora_cartao;
    }

    public function setTaxa_operadora_cartao($taxa_operadora_cartao){
        $this->taxa_operadora_cartao = $taxa_operadora_cartao;
    }
     ...
     public function printStatus() {
        switch ($this->status) {
            case ABERTO:
                    echo fin_lancamentos_receberPojo::$ABERTO;
                break;

            case PAGO:
                    echo fin_lancamentos_receberPojo::$PAGO;
                break;
            
            case CANCELADO:
                    echo fin_lancamentos_receberPojo::$CANCELADO;
                break;

            case APROVADO:
                    echo fin_lancamentos_receberPojo::$APROVADO;
                break;
