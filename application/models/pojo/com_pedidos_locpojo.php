...
class Com_pedidos_locPojo extends CI_Model {
    ...
    public function printStatus() {
        switch ($this->status) {
            case ANDAMENTO:
                    echo com_pedidos_locPojo::$ANDAMENTO;
                break;

            case FINALIZADO:
                    echo com_pedidos_locPojo::$FINALIZADO;
                break;

            case CANCELADO:
                    echo com_pedidos_locPojo::$CANCELADO;
                break;

            case APROVADO:
                    echo com_pedidos_locPojo::$APROVADO;
                break;

            case PROCESSAMENTO:
                    echo com_pedidos_locPojo::$PROCESSAMENTO;
                break;
