 ...
 */
class Com_clientesPojo extends CI_Model {
	...
	if(isset($dados["telefone2"]))
        ...
        if(isset($dados["status"]))
         ...
         if(isset($dados["terceirizado"]))
            $this->terceirizado = $dados["terceirizado"];
        ...
        public function getStatus() {
         ...
         public function getTerceirizado() {
        ...
        public function setStatus($status) {
         ...
         public function setTerceirizado($terceirizado) {
    ...
    public function cidadeIs($cidade){
       ...
       public function statusIs($status){
        ...
        switch ($this->status) {
            case ATIVO:
                    echo com_clientesPojo::$ATIVO;
                break;

            case BLOQUEADO:
                    echo com_clientesPojo::$BLOQUEADO;
                break;
