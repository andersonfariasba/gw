 ...
 */
class Est_produtosPojo extends CI_Model {
	...
	if(isset($dados["codigo"]))
	    ...
	    if(isset($dados["valor_venda"]))
         ...
         if(isset($dados["valor_despesas"]))
            $this->valor_despesas = $dados["valor_despesas"];

         if(isset($dados["percentual_lucro"]))
            $this->percentual_lucro = $dados["percentual_lucro"];
        ...
        if(isset($dados["habilitado_venda"]))
          ...
          if(isset($dados["habilitado_locacao"]))
            $this->habilitado_locacao = $dados["habilitado_locacao"];
        ...
        public function getHabilitado_locacao() {
            return $this->habilitado_locacao;
        }
        ...
        public function setHabilitado_venda($habilitado_venda) {
         ...
         public function setHabilitado_locacao($habilitado_locacao) {
            $this->habilitado_locacao = $habilitado_locacao;
        }
        ...
        public function getValor_despesas(){
        return $this->valor_despesas;
    }

    public function setValor_despesas($valor_despesas){
    ...
    public function setPercentual_lucro($percentual_lucro){
       ...
       public function statusIs($status){
        ...
        switch ($this->status) {
            case ATIVO:
                    echo est_produtosPojo::$ATIVO;
                break;

            case BLOQUEADO:
                    echo est_produtosPojo::$BLOQUEADO;
                break;
