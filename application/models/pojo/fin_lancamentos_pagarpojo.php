 ...
 */
class Fin_lancamentos_pagarPojo extends CI_Model {
    ...
    if(isset($dados["pagamento_antecipado"]))
     ...
     public function contaBancoIs($conta_banco){
        ...
        switch ($this->status) {
            case ABERTO:
                    echo fin_lancamentos_pagarPojo::$ABERTO;
                break;

            case PAGO:
                    echo fin_lancamentos_pagarPojo::$PAGO;
                break;
            
            case CANCELADO:
                    echo fin_lancamentos_pagarPojo::$CANCELADO;
                break;

            case APROVADO:
                    echo fin_lancamentos_pagarPojo::$APROVADO;
                break;
