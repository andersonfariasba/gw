...
class Com_pedidos_locBusiness extends CI_Model {
	...
	public function cadastrar($dados){
        try {
            ...
            $pedidoDao = $this->Factory->createDao("com_pedidos_loc");
            $pedidoDao->connect();
    ...
    public function filtro($tipo,$dados=null){
     ...
     public function filtro_entrega($id_pedido){
        try {
            ...
            $pedidoDao = $this->Factory->createDao("com_pedidos_loc");
            $pedidoDao->connect();
            $listPedido = $pedidoDao->filtro_entrega($id_pedido);
            $pedidoDao->disconnect();
            return $listPedido;
    ...
    public function excluir($id_pedido){
        ...
        public function gerar_codigo(){
            try {
                 $codigoDao = $this->Factory->createDao("com_pedidos_loc");
                 $codigoDao->connect();
    ...
    public function listar_por_cliente($id_cliente,$tipo=null){
      ...
      public function ajax_listar_entrega(){
        try {
            ...
            $categoriaDao = $this->Factory->createDao("com_pedidos_loc");
